import { JSBI, Pair, Percent, TokenAmount } from '@totoroswap/sdk'
...
const AddLiquidityBtn = styled.div`
  margin: 10px 0;
  font-size: 16px;
  text-align: center;
      ...
      <AutoColumn gap="12px">
        <FixedHeightRow>
          ...
          <RowFixed gap="8px">
            ...
            >
              {showMore ? <ChevronUp size="40" /> : <ChevronDown size="40" />}
            </ButtonEmpty>
          </RowFixed>
        </FixedHeightRow>
        ...
        {showMore && (
          <AutoColumn gap="8px">
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text fontSize={16} fontWeight={500}>
                  <CurrencyLogo size="32px" style={{ marginRight: '8px' }} currency={currency0} />
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text fontSize={16} fontWeight={500}>
                  <CurrencyLogo size="32px" style={{ marginRight: '8px' }} currency={currency1} />
            ...
            {userDefaultPoolBalance && JSBI.greaterThan(userDefaultPoolBalance.raw, BIG_INT_ZERO) && (
              <>
                ...
                <AddLiquidityBtn as={Link} to={`/add/${currencyId(currency0)}/${currencyId(currency1)}`}>
                  + AddLiquidity instead
                </AddLiquidityBtn>
              </>
            )}
